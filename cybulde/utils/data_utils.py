...
def initialised_dvc_storage(dvc_remote_name:str, dvc_remote_url:str)->None:
    if not run_shell_command("dvc remote list"):
        DATA_UTILS_LOGGER.info("Initialising DVC Storage...")
        ...
        DATA_UTILS_LOGGER.info("DVC storage was already initialised...")
